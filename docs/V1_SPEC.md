...
- `Host syscalls`: gated until explicit host effect declarations and syscall ABI semantics exist. Evidence anchors: `syscall_intrinsics_are_rejected_as_host_effect_gates`, `stdlib_io_uring_import_is_gated_before_loading_sketch`, `module_graph_gates_stdlib_io_uring_import_before_loading_sketch`, `@builtin.syscall0`, and `@builtin.syscall6`.
