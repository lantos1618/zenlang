...
| Generic syntax and explicit behavior bounds | experimental | `parser::tests::parse_nested_generics`, `parser::tests::parse_rejects_generic_behavior_function_bound_with_clear_error`, `parser::tests::parse_rejects_generic_behavior_type_bound_with_clear_error`, `typechecker::tests::generic_function_collection`, `typechecker::tests::generic_behavior_bound_accepts_type_with_impl`, `typechecker::tests::generic_behavior_bound_accepts_inherited_behavior_impl`, `typechecker::tests::generic_behavior_bound_rejects_type_without_impl`, `tests/zen/behavior_inherited_generic_dispatch.zen` |
