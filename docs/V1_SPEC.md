...
exist. This includes `.extends`, comptime execution, type matching, async
...
| Behavior inheritance `.extends` | gated | `parser::tests::parse_rejects_gated_behavior_extends_with_clear_error` |
