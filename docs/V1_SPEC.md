...
- `JSON/YAML IR boundaries`: gated. JSON is the machine-readable exchange format
  ...
  checked typed specialization. Symbols JSON for generic behavior-bound UFCS is
  pinned by
