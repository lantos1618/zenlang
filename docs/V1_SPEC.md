...
| Behavior declarations `Name: behavior { method: (Self) Return }` | experimental | `parser::tests::parse_behavior_declaration`, `resolver_phase2::resolver_records_behavior_method_signatures`, `resolver_phase2::resolver_records_behavior_default_method_body_locals`, `typechecker::tests::behavior_declaration_collection`, `typechecker::tests::check_program_with_symbols_validates_resolver_behavior_method_signatures`, `typechecker::tests::check_program_with_symbols_requires_resolver_behavior_default_locals` |
