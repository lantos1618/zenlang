...
| Non-behavior impl blocks `Type.impl = { ... }` | experimental | `parser::tests::parse_impl_block`, `resolver_phase2::resolver_accepts_non_behavior_impl_blocks_as_method_symbols`, `tests/zen/type_impl_methods.zen`, `tests/zen/multi_file_type_impl/main.zen`, `integration::test_type_impl_methods`, `integration::test_multi_file_type_impl_imports`, `integration::generic_specializations_do_not_emit_unspecialized_c_symbols` |
