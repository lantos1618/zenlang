...
- `JSON/YAML IR boundaries`: gated. JSON is the machine-readable exchange format
  ...
  return type `Self` on generic struct and enum receivers. Symbols JSON for generic Option enum templates
