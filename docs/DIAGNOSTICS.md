...
| `E0203` | gated compiler-owned intrinsic call, including reserved async scheduler intrinsics before Sync/Async task lowering is implemented. | `tests/fixtures/ir_json/diagnostics_async_intrinsic_gate.golden.json` |
