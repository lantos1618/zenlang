...
| `E5000` | generic inference conflict, including conflicting inferred type arguments for generic functions and methods. | `tests/fixtures/ir_json/diagnostics_generic_function_inference.golden.json`, `tests/fixtures/ir_json/diagnostics_generic_result_method_inference.golden.json` |
...
| `E6004` | generic behavior-bound failure when a concrete type does not satisfy a required behavior bound. | `tests/fixtures/ir_json/diagnostics_generic_function_bound.golden.json`, `tests/fixtures/ir_json/diagnostics_generic_result_method_bound.golden.json` |
