...
| `E5002` | type arguments were supplied to a non-generic function, method, struct, enum, or behavior. | nongeneric annotation, constructor, function, builtin, module function, method, and behavior fixtures |
