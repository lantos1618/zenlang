...
impl<'ctx> Compiler<'ctx> {
    pub fn compile_struct_literal(&mut self, name: &str, fields: &[(String, ast::Expression)]) -> Result<BasicValueEnum<'ctx>, CompileError> {
    ...
    pub fn compile_struct_field(&mut self, struct_: &ast::Expression, field: &str) -> Result<BasicValueEnum<'ctx>, CompileError> {
