...
impl Parser {
    pub(in crate::parser) fn parse_generic_declaration_suffix(
        &mut self,
        name: String,
        public: bool,
        name_span: Span,
    ...
    pub(in crate::parser) fn parse_type_suffix_declaration(
        &mut self,
        name: String,
        public: bool,
        name_span: Span,
        ...
        if let Ok(keyword) = method_name.parse::<TypeDeclarationKeyword>() {
            return match keyword {
                ...
                TypeDeclarationKeyword::Requires => self.parse_behavior_requires(name, name_span),
                TypeDeclarationKeyword::Extends => self.parse_behavior_extends(name, name_span),
                TypeDeclarationKeyword::Derive => self.parse_behavior_derive(name, name_span),
            };
        }
