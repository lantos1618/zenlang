...
#[test]
fn emit_json_mir_multi_file_type_impl_imported_type_dependency_schema_matches_golden() {
    assert_mir_golden(
        "tests/zen/multi_file_type_impl_imported_type_dependency/main.zen",
        "tests/fixtures/ir_json/mir_multi_file_type_impl_imported_type_dependency.golden.json",
