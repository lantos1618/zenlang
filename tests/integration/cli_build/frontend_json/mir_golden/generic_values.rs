...
#[test]
fn emit_json_mir_multi_file_generic_imported_worklist_multi_specialization_schema_matches_golden() {
    assert_mir_golden(
        "tests/zen/multi_file_generic_imported_worklist_multi_specialization/main.zen",
        "tests/fixtures/ir_json/mir_multi_file_generic_imported_worklist_multi_specialization.golden.json",
