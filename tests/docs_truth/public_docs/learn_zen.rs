...
fn learn_zen_guide_covers_core_tour_and_gated_previews() {
    ...
    for required in [
        ...
        "static data plus a small view value",
        "allocator, capacity field, destructor, or ownership transfer",
        "Runtime string\nconstruction belongs on an allocator-aware API",
        "Use this rule when reading any text API",
        "Runtime text that can grow or be freed",
        ...
        "closed control surface for loops",
        "choose exactly one visible edge with `done` or\n`next`",
        ...
        "That outer type is the timing boundary",
        "does not let sync allocation and async\nallocation collapse into the same call shape",
        "If a form erases one of those facts",
